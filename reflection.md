...
For future improvement, I want to try   Advanced RAG. After ChromaDB retrieves the Top-K chunks, the reranker can check those chunks again and put the most relevant one first. I think this can reduce unrelated context and help the LLM generate a better and more accurate answer.